...
<html>
<head>
  <title>Alexandra Fraser  &raquo; Interlitq</title>
...
<!-- fwtable fwsrc="content.png" fwbase="home.gif" fwstyle="Dreamweaver" fwdocid = "742308039" fwnested="0" -->
 ...
 src="../alexandra-fraser/art_small.jpg" alt="Click to enlarge picture." name="home_r2_c2"
 border="0" height="230" width="250"></a></td>
            <td rowspan="2"><img name="home_r2_c3"
 src="../../images/home_img/home_r2_c3.gif" alt="" border="0"
 height="242" width="17"></td>
            <td colspan="2" class="titulo2" valign="top">A Reflection on Resilience <span
 class="texto2">by <a href="../alexandra-fraser/bio.php"
 class="link3">Alexandra Fraser</a><br>
 </span></td>
            <td>&nbsp;</td>
            <td><img src="/images/spacer.gif" alt="" border="0"
...
<p>Take a beginning<br>
does it scare you?<br><br>

those tiny green leaves<br>
pushing aside the crumbled clay<br><br>

that optimism of finding<br>
a place in the sun<br><br>

the few silvery drops<br>
that slip from a branch<br><br>

roll through gutters<br>
heralding the deluge<br><br>

first words on a line<br>
a letter to your lover&nbsp;&nbsp; &nbsp;   indelible ink<br><br>

the first breath into the mask<br>
as you submerge<br><br>

suddenly gripped<br>
by fear of drowning<br><br>

the earth drying gasping flicking to flame<br>
you can stay and fight or run &nbsp;&nbsp; &nbsp;   run  &nbsp;&nbsp; &nbsp;  run<br><br>

the small sound in the night’s airless dark<br>
the coiling cold worm that lives within<br><br>

living alone &nbsp;&nbsp; &nbsp;   saying goodbye<br>
how will you start?<br><br>
  
With each breath push in a seed<br>
get your hands in the soil &nbsp;&nbsp; &nbsp;   feel the grit<br><br>

bring water  &nbsp;&nbsp; &nbsp;  a gentle warmth<br>
list the words you love   &nbsp;&nbsp; &nbsp; take cuttings<br></p>
