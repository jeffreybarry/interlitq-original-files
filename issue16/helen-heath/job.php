...
<html>
<head>
  <title>Helen Heath  &raquo; Interlitq</title>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tbody>
    <tr>
      <td align="right" valign="top" width="10%"><?php include("../../issue16/menu_issue16.php"); ?>
      <div align="right"></div>
      </td>
...
<!-- fwtable fwsrc="content.png" fwbase="home.gif" fwstyle="Dreamweaver" fwdocid = "742308039" fwnested="0" -->
 ...
 onmouseup="MM_openBrWindow('artwork.html','','width=650,height=500')"><img
 src="art_small.jpg" alt="Click to enlarge picture." name="home_r2_c2"
 border="0" height="124" width="291"></a></td>
 ...
 class="link3">Helen Heath</a></span></td>
            <td>&nbsp;</td>
            <td><img src="/images/spacer.gif" alt="" border="0"
 ...
 height="219" width="1"></td>
          ...
          <tr>
            ...
            <br>
            <p><strong>Fire Burns</strong></p>
            <p>Fire burns clean<br>
			flesh from the bone.</p>

			<p>Silver earrings melt <br>
			and flammable fabric.</p>

			<p>Embalmer's fluid<br>
			ignites easily, smoke rises.</p>

			<p>They use<br>
			a large tool to grind the bones.</p>

			<p>There's too much <br>
			for a small box to contain,</p>

			<p>wrapped in brown paper<br>
			with your name on it,</p>

			<p>my father the postman<br>
			delivering you home.</p>
            &nbsp;<br>
             &nbsp;<br>
            <p><strong>The Nature of Things</strong></p>
            <p>My hand runs over<br>
			my distended belly.<br>
			I think of my mother,<br>
			her own bulge,<br>
			talking to my father about getting ready<br>
			for when the baby came.<br>
			Did she notice his tears?<br>
			The morphine<br>
			and tumours in her belly and brain<br>
			removed her completely <br>
			from the present.<br>
			I dreamt last night of my daughter<br>
			ripping her way out of me<br>
			like an alien.</p>
             &nbsp;<br>
             &nbsp;<br>
            <p><strong>Truth</strong></p>
            <p>Let's not talk about<br>
			the whole truth.<br>
			Better to let small parts <br>
			speak for the whole &mdash;<br>
			a look, a hand<br>
			in the small of my back.<br>
			Better to find that<br>
			the truth lies<br>
			in the smallest things we do.</p>
            <p></p>
            </td>
            <td><img src="/images/spacer.gif" alt="" border="0"
