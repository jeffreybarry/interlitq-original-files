...
<html>
<head>
  <title>Geraldine Maxwell  &raquo; Interlitq</title>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tbody>
    <tr>
      <td align="right" valign="top" width="10%"><?php include("../../issue15/menu_issue15.php"); ?>
      <div align="right"></div>
      </td>
...
<!-- fwtable fwsrc="content.png" fwbase="home.gif" fwstyle="Dreamweaver" fwdocid = "742308039" fwnested="0" -->
 ...
 height="242" width="17"></td>
            <td colspan="2" class="titulo2" valign="top">Two Poems <span
 class="texto2">by <a href="http://interlitq.org/issue13-2/geraldine-maxwell/bio.php"
 class="link3">Geraldine Maxwell</a></span></td>
            <td>&nbsp;</td>
            <td><img src="/images/spacer.gif" alt="" border="0"
 ...
 height="219" width="1"></td>
          ...
          <tr>
            ...
            &nbsp;<br>
            <p><strong>Black earthed soul</strong></p>
            
           
            <p>Your black earthed soul flattened up to me just then<br>
            with the ancient blood and fall of it, and in a blink<br>
            paused me like a flag in the breeze<br>
            of a seldom breath<br>
            and I considered again those long and dark fears <br>
            and how they never grow as fast <br>
            as when I locked into a country of them<br>
            and that in this now cooler morning I can dress<br>
            less flesh on me from your black earthed soul.</p>
<p LANG="es-ES">&nbsp;
</p>
            <p><strong>Neva</strong></p>
           
            
            <p>What lies in St Petersburg lies there still<br>
            like the coffee cup on top of my half read book<br>
            and the tinnitus filling of your bath<br>
            as the couple flickered on the TV and on the bed<br> 
            ourselves flickering upon the fault line <br>
            with you in your head below <br>
            as if still upon the Neva<br> 
            bowing beneath that last small bridge<br>
            before the approach to her gape of vast water<br>
            darkening now and glittered from a moon <br>
            that time upon time <br>
            lies there still.</p>
<p><BR>
          </p>
            <p><BR>
