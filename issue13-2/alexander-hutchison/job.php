...
<html>
<head>
  <title>Alexander Hutchison, True as Tides &raquo; Interlitq</title>
...
<!-- fwtable fwsrc="content.png" fwbase="home.gif" fwstyle="Dreamweaver" fwdocid = "742308039" fwnested="0" -->
 ...
 height="242" width="17"></td>
            <td colspan="2" class="titulo2" valign="top">True as Tides <span
 class="texto2">by <a href="bio.php"
 class="link3">Alexander Hutchison</a></span></td>
            <td>&nbsp;</td>
            <td><img src="/images/spacer.gif" alt="" border="0"
 height="23" width="1"></td>
          ...
          <tr>
            ...
            <p LANG="en-GB">'True as tides' the saying <br>
            goes in Newfoundland; <br>
            and 'sure as shit shoots <br>
            off a shovel' no doubt <br>
            that would go down too.</p>
            
            <p LANG="en-GB">As to the name, the<br>
            middle syllable goes<br>
            unstressed by those<br>
            who live there. Slide</p>
            
            <p LANG="en-GB">over the first two; <br>
            let your tongue come<br>
            down on 'land'. John <br>
            Donne was the boy<br>
            first traced its outline</p>
           
            <p LANG="en-GB">mapped on his lady's<br>
            <em>sine qua non</em>. Though</SPAN><br>
            'Look what I've found!'<br>
            didn't quite match his <br>
            quaint discovery, like<br>
            planting his standard <br>
            where <em>nothing else is.</em></p>
