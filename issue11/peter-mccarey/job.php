...
<!-- fwtable fwsrc="content.png" fwbase="home.gif" fwstyle="Dreamweaver" fwdocid = "742308039" fwnested="0" -->
 ...
 onmouseup="MM_openBrWindow('../../issue11/peter-mccarey/artwork.html','','width=360,height=500')"><img
 ...
 height="242" width="17"></td>
            <td colspan="2" class="titulo2" valign="top">
             <SPAN LANG="en-GB">That Auld Sign Language </SPAN><span
 class="texto2">by <a href="../../issue11/peter-mccarey/bio.php"
 class="link3">Peter McCarey</a></span></td>
            <td>&nbsp;</td>
            <td><img src="/images/spacer.gif" alt="" border="0"
 height="23" width="1"></td>
          ...
          <tr>
            ...
            For all sine lang, a wave<br>
            Bye bye for seas between us<br>
            Baith hae roared our tonsils hoarse.<br>
            A hoarse? Whit's it daen at the Rangers end?<BR>
              For Bertie Auld a spline, my dear:<br>
            Reset that gnathous grin.<br>
            You point: a bovril and a bacon roll. No, gies a pie.<br>
            A spy? There, elbow-crawling up the park,<br>
            Night vision trained on Dobbin's jaw<br>
            Hingin open like a sock drawer. No, that's Bertie.<br>
            Special forces. One of them? The swine.<br>
            Sine out that gless and pour yoursel<br>
            Wan fifty faithoms deep. And here is a sign for you:<BR>
              The spine on the rose. The last defender<br>
            And the open goal.<br>
            <p><BR>
            </p>
            <p><BR>
            </p>            </td>
