...
<html>
<head>
  <title>Kevin Ireland, Onward Citizens  &raquo; Interlitq</title>
...
<!-- fwtable fwsrc="content.png" fwbase="home.gif" fwstyle="Dreamweaver" fwdocid = "742308039" fwnested="0" -->
 ...
 height="242" width="17"></td>
            <td colspan="2" class="titulo2" valign="top">Onward Citizens <span
 class="texto2">by <a href="bio.php"
 class="link3">Kevin Ireland</a></span></td>
            <td>&nbsp;</td>
            <td><img src="/images/spacer.gif" alt="" border="0"
 height="23" width="1"></td>
          ...
          <tr>
            ...
            <p>Who has ever before seen such strong purpose<br>
            in the streets? Everyone’s fists are clenched.<br>
            Why such determination?  Why do they march<br>
            in step? Their boots drum woodenly, like mallets.</p>
            
            <p>No one looks to right or left. This is heady,<br>
            steadfast stuff. Jaws set, eyes glazed,<br>
            these cohorts provide answers to the doubters.<br>
            It would be very wrong to laugh. Hurrah.</p>
            
            <p>Even the dogs have caught the mood.<br>
            There is a ferocious platoon of them<br>
            ghosting in formation along an alleyway.<br>
            Their teeth are bared They have a mission.</p>
            
            <p>Children arrive. None is without a bold flag<br>
            or banner. You can actually smell<br>
            their commitment. It combines a fragrant whiff<br>
            of shoe-polish with a touch of disinfectant.</p>
            <p> ...</p>
            <p>Who has ever before seen such a public display<br>
            of united purpose? We are falling over ourselves<br>
            to confirm our noble ideals. Soon we shall learn<br>
            the identity of those it will be necessary to hate. </p>            </td>
