...
<html>
<head>
  <title>Laurice Gilbert, Cornwall, Ontario  &raquo; Interlitq</title>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tbody>
    <tr>
      <td align="right" valign="top" width="10%"><?php include("../../issue14/menu_issue14.php"); ?>
      <div align="right"></div>
      </td>
...
<!-- fwtable fwsrc="content.png" fwbase="home.gif" fwstyle="Dreamweaver" fwdocid = "742308039" fwnested="0" -->
 ...
 height="242" width="17"></td>
            <td colspan="2" class="titulo2" valign="top">Cornwall, Ontario <span
 class="texto2">by <a href="bio.php"
 class="link3">Laurice Gilbert</a></span></td>
            <td>&nbsp;</td>
            <td><img src="/images/spacer.gif" alt="" border="0"
 height="23" width="1"></td>
          ...
          <tr>
            ...
            <p>Snow bites the air, but not yet the ground,<br>
            and all day the geese have delta’d overhead<br>
            shouting each other directions,<br>
            navigating by stars I don’t recognise.</p>
            
            <p>There is no footpath, and I walk<br>
            between the road and the ha-ha<br>
            on bald autumn grass.<br>
            Here, the cars keep right.</p>
           
            <p>The houses have basement windows<br>
            peering at me from ground level<br>
            like gopher’s eyes.</p>
           
            <p>Halloween lights like icicles <br>
            outline entrance doors, <br>
            their owners impatient for winter.</p>
           
            <p>Organic and plastic Jack-o’-Lanterns<br>
            occupy front lawns <br>
            in pre-loved clothes and wicker rockers.</p>
             
            <p>There are ghosts in the windows<br>
            backed by the flickering blue lights<br>
            of Saturday night entertainment.</p>
             
            <p>Only the last gravel driveway <br>
            in a progressive neighbourhood<br>
            helps me find my way back<br>
            to familiar territory.</p>
             
            <p>This is Ross St in November<br>
            and the house of my hosts<br>
            echoes the unfamiliar stars, the bald grass,<br>
            goggle-eyed gophers, square-eyed ghosts.</p>            </td>
